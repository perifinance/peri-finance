...
module.exports = async ({ addressOf, deployer, runStep }) => {
	...
	// // this breaks vesting
	// const migratableBalance = await PeriFinance.balanceOf(frozenOrPreviousEscrow.address);
	...
	// } else {
	// 	console.log(
	// 		gray('Skipping PeriFinance.migrateEscrowContractBalance as frozen contract has no SNX balance.')
	// 	);
	// }
