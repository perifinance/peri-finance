...
module.exports = async ({
	...
	try {
		...
		currentPeriFinanceSupply = await oldPeriFinance.totalSupply();
		...
		inflationSupplyToDate = parseUnits(currentPeriFinanceSupply.toString(), 'wei').sub(
	...
	parameterNotice({
		...
		'PeriFinance totalSupply': `${Math.round(formatUnits(currentPeriFinanceSupply) / 1e6)}m`,
