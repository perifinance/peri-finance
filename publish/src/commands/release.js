...
const release = async ({ branch, release, version, yes }) => {
	...
	await axios({
		method: 'post',
		url: 'https://circleci.com/api/v2/project/github/FinancePeri-Team/releases/pipeline',
		headers: {
...
module.exports = {
	...
	cmd: program =>
		program
			...
			.option(
				'-b, --branch <value>',
				'The branch of periFinance to release from (e.g. master, staging or develop)'
			)
