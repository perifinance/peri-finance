...
contract DebtMigratorOnEthereum is BaseDebtMigrator {
    ...
    bytes32 private constant CONTRACT_SYNTHETIX_BRIDGE_TO_OPTIMISM = "PeriFinanceBridgeToOptimism";
    bytes32 private constant CONTRACT_SYNTHETIX_DEBT_SHARE = "PeriFinanceDebtShare";
    ...
    function _synthetixBridgeToOptimism() internal view returns (IPeriFinanceBridgeToOptimism) {
        return IPeriFinanceBridgeToOptimism(requireAndGetAddress(CONTRACT_SYNTHETIX_BRIDGE_TO_OPTIMISM));
    }

    function _synthetixDebtShare() internal view returns (IPeriFinanceDebtShare) {
        return IPeriFinanceDebtShare(requireAndGetAddress(CONTRACT_SYNTHETIX_DEBT_SHARE));
    }
    ...
    function resolverAddressesRequired() public view returns (bytes32[] memory addresses) {
        ...
        //newAddresses[1] = CONTRACT_LIQUIDATOR_REWARDS;
        newAddresses[1] = CONTRACT_SYNTHETIX_BRIDGE_TO_OPTIMISM;
        newAddresses[2] = CONTRACT_SYNTHETIX_DEBT_SHARE;
